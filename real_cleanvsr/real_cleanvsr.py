...
class RealCleanVSR(RealESRGAN):
    """RealCleanVSR model for real-world video super-resolution.
    ...
    Args:
        ...
        dynamic_clean_loss (dict, optional): Config for the dynamic clean loss.
            Default: None.
    ...
    def __init__(self,
        ...
        self.dynamic_clean_loss = MODELS.build(
            dynamic_clean_loss) if dynamic_clean_loss else None
    ...
    def g_step(self, batch_outputs, batch_gt_data):
        ...
        if self.dynamic_clean_loss:
            losses['loss_clean'] = self.dynamic_clean_loss(fake_g_lq, gt_clean)
