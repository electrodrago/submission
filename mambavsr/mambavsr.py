...
class MambaVSR(RealESRGAN):
    """MambaVSR model for video super-resolution.
    ...
    Args:
        ...
        reconstruct_loss (dict, optional): Config for the dynamic clean loss.
            Default: None.
    ...
    def __init__(self,
        ...
        self.reconstruct_loss = MODELS.build(
            reconstruct_loss) if reconstruct_loss else None
    ...
    def extract_gt_data(self, data_samples):
        ...
        if self.reconstruct_loss:
            gt_clean = F.pixel_unshuffle(gt_pixel, 4).view(n, t, -1, h // 4, w // 4)
        else:
            gt_clean = None
    ...
    def forward_train(self, batch_inputs, data_samples=None):
        ...
        Run forward of generator with ``return_reconstructed=True``
